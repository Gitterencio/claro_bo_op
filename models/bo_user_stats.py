...
class BOUserStats(models.Model):
    ...
    def set_count_asigned(self):
        ...
        set_filter_active=[('ribbon_dynamic_title','!=',"NO-GESTIONAR"),('estado_venta','!=',"caida"),('estado_venta','!=',"anulada"),('ribbon_dynamic_title','!=',"FIN"),('bo_assigned_user', '=', self.bo_assigned_user.id)]
